...
namespace MyGardenWEB.Migrations
{
    ...
    [Migration("20240315173219_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyGardenWEB.Data.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyGardenWEB.Data.Client", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyGardenWEB.Data.Product", b =>
                {
                    b.HasOne("MyGardenWEB.Data.Category", "Categories")
                        .WithMany("Products")
